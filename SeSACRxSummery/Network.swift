...
class BoxOfficeNetwork {
    ...
    static func fetchBoxOfficeData(date: String) -> Observable<Movie> {
        ...
        return Observable<Movie>.create { observer in
            ...
            guard let url = URL(string: "https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=38a86862e6156f84c1dfb76ca9ecd677&targetDt=\(date)") else {
